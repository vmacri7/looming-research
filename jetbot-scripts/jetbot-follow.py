...
while True:
    ...
    if looming_started == True and (largest_area+begining_area) != 0:
        ...
        if looming < -0.05:
            ...
            moving_text = "Stay"
            if location_text == "Left Zone" or location_text == "Mid-Left Zone":
                robot.left_motor.value = -1 * speed_constant
                robot.right_motor.value = speed_constant
            elif location_text == "Right Zone" or location_text == "Mid-Right Zone":
                robot.left_motor.value = speed_constant
                robot.right_motor.value = -1 * speed_constant
            else:
